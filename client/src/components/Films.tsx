...
const FilmList = () => {
  ...
  //   const res = value ? (
  //     <>
  //       <EyeIcon className="h-5 w-5 text-green-500 inline" />
  //     </>
  //   ) : (
  //     <>
  //       <EyeOffIcon className="h-5 w-5 text-indigo-500 inline" onClick={onClick} />
  //     </>
  //   );
  ...
  const Title = (value: string, row: FilterableFilm) => {
    ...
    // return <span className="no-underline hover:underline cursor-pointer" onClick={() => selectFilm(row.id)}>
    //   <FilmIcon className="h-5 w-5 inline mr-2" /> {res}
    // </span>
  ...
  const Actions = (value: string, row: FilterableFilm) => {
    ...
    return (
      <div className="flex justify-evenly m-1">
        <svg onClick={onClickSeen} className="cursor-pointer h-6 w-6 hover:text-blue-600 rounded-full hover:bg-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          {row.seen ?
            (<>
        ...
        <svg onClick={() => selectFilm(row.id)} className="cursor-pointer h-6 w-6 hover:text-green-600 rounded-full hover:bg-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        </svg>
        <svg className="cursor-pointer w-6 h-6 hover:text-red-600 rounded-full hover:bg-gray-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
